        ...
        records.append(
            {
                ...
                'church_country': normalize_text(data.get('Church Country')),
                'church_address': normalize_text(data.get('Church Address')) or build_full_address(
                    normalize_text(data.get('Church Street Address')),
                    normalize_text(data.get('Church City')),
                    normalize_text(data.get('Church Province')),
                    normalize_text(data.get('Church Country')),
                ),
